...
//import org.nzy.mapper.AdminMenusMapper;
...
//		TbUser admin = (TbUser) principalCollection.getPrimaryPrincipal();
...
//		List<TbUser> admins = tbUserMapper.selectByExample(example);
//		// 账号不存在
