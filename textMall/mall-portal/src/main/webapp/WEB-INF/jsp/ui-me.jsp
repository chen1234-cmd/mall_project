...
<body style="background:#fc0f42">
	<header class="aui-header-default aui-header-fixed aui-header-bg">
		<a href="#" class="aui-header-item">
			...
			<div id="scrollSearchDiv">
				<img src="themes/img/user/head-3.jpg" alt="">
			</div>
		</a>
			...
			<div class="aui-me-content-list">
				<div class="aui-me-content-item">
					<div class="aui-me-content-item-head">
						...
						<div class="aui-me-content-item-title">够味达</div>
					</div>
				...
				<div class="aui-me-content-card">
					<h3><i class="aui-icon aui-card-me"></i>铂金会员</h3>
	...
	<footer class="aui-footer-default aui-footer-fixed">
		...
		<a href="ui-me.html" class="aui-footer-item aui-footer-active">
